...
const LEFT_WIDTH_PERCENTAGE = 37; // Set it to 50 if you want symmetric left and right sides' widths
const RIGHT_WIDTH_PERCENTAGE = 60; // Set it to 50 if you want symmetric left and right sides' widths
